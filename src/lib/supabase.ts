...
export const DEFAULT_MENU_ITEMS: MenuItem[] = [
  ...
  {
    id: '12',
    title: 'Jordgubbssylt & Vispad Grädde 🍓',
    description: 'Klassisk sötsyrlig jordgubbssylt och luftig vispad grädde till tårtbotten.',
    category: 'Bygg din Tårta',
    price: 0,
    available: true,
  },
  {
    id: '13',
    title: 'Nutella & Skivad Banan 🍫🍌',
    description: 'Krämig Nutellabredning toppad med färsk skivad banan.',
    category: 'Bygg din Tårta',
    price: 0,
    available: true,
  },
  {
    id: '14',
    title: 'Chokladsås & Strössel 🍫✨',
    description: 'Varm chokladsås med färgglatt festströssel.',
    category: 'Bygg din Tårta',
    price: 0,
    available: true,
  },
  {
    id: '15',
    title: 'Maränger & Vattenmelonsvampar 🍨🍬',
    description: 'Frasiga mini-maränger och söta vattenmelonsvampar.',
    category: 'Bygg din Tårta',
    price: 0,
    available: true,
  },
  {
    id: '16',
    title: 'Varma Churros med Nutelladipp 🍫',
    description: 'Frasiga churros rullade i kanelsocker med Nutella på sidan.',
    category: 'Bygg din Tårta',
    price: 0,
    available: true,
  },
